...
public class HorseUtil {
	...
	* @return the matching horses
	*/
	public static List<Horse> findByAgeAndCurrentCreateDate(int age) {
		return getPersistence().findByAgeAndCurrentCreateDate(age);
	}
	...
	* @return the range of matching horses
	*/
	public static List<Horse> findByAgeAndCurrentCreateDate(int age, int start,
		int end) {
		return getPersistence().findByAgeAndCurrentCreateDate(age, start, end);
	}
	...
	*/
	public static List<Horse> findByAgeAndCurrentCreateDate(int age, int start,
		int end, OrderByComparator<Horse> orderByComparator) {
		return getPersistence()
				   .findByAgeAndCurrentCreateDate(age, start, end,
			orderByComparator);
	}
	...
	* @return the first matching horse, or <code>null</code> if a matching horse could not be found
	*/
	public static Horse fetchByAgeAndCurrentCreateDate_First(int age,
		OrderByComparator<Horse> orderByComparator) {
		return getPersistence()
				   .fetchByAgeAndCurrentCreateDate_First(age, orderByComparator);
	}
	...
	* @return the last matching horse, or <code>null</code> if a matching horse could not be found
	*/
	public static Horse fetchByAgeAndCurrentCreateDate_Last(int age,
		OrderByComparator<Horse> orderByComparator) {
		return getPersistence()
				   .fetchByAgeAndCurrentCreateDate_Last(age, orderByComparator);
	}
	...
	* @return the matching horses
	*/
	public static List<Horse> findByAgeAndCurrentCreateDate(int[] ages) {
		return getPersistence().findByAgeAndCurrentCreateDate(ages);
	}
	...
	*/
	public static List<Horse> findByAgeAndCurrentCreateDate(int[] ages,
		int start, int end) {
		return getPersistence().findByAgeAndCurrentCreateDate(ages, start, end);
	}
	...
	*/
	public static List<Horse> findByAgeAndCurrentCreateDate(int[] ages,
		int start, int end, OrderByComparator<Horse> orderByComparator) {
		return getPersistence()
				   .findByAgeAndCurrentCreateDate(ages, start, end,
			orderByComparator);
	}
	...
	* @param age the age
	*/
	public static void removeByAgeAndCurrentCreateDate(int age) {
		getPersistence().removeByAgeAndCurrentCreateDate(age);
	}
	...
	* @return the number of matching horses
	*/
	public static int countByAgeAndCurrentCreateDate(int age) {
		return getPersistence().countByAgeAndCurrentCreateDate(age);
	}
	...
	* @return the number of matching horses
	*/
	public static int countByAgeAndCurrentCreateDate(int[] ages) {
		return getPersistence().countByAgeAndCurrentCreateDate(ages);
	}
